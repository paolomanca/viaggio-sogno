...
INSERT INTO FINAL_PACKAGE (PACKAGE_idPACKAGE, USER_idUSER, IDFINAL_PACKAGE_RELATIVE) values (1, 1, 2); -- ID:2
UPDATE ID_POOL SET NEXT=3 WHERE IDPOOL_ID=1;
...
UPDATE ID_POOL SET NEXT=3 WHERE IDPOOL_ID=2;
